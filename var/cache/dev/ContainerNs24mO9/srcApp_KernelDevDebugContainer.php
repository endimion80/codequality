...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\CollaboratorUserController' => 'getCollaboratorUserControllerService',
            'App\\Controller\\FrontendController' => 'getFrontendControllerService',
            'App\\Controller\\SecurityController' => 'getSecurityControllerService',
            'App\\Controller\\TestController' => 'getTestControllerService',
            'App\\Controller\\UtilsController' => 'getUtilsControllerService',
    ...
    protected function getApiControllerService()
    {
        ...
        return $this->services['App\\Controller\\ApiController'] = new \App\Controller\ApiController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()));
    }
    ...
    protected function getBackendControllerService()
    {
        ...
        $this->services['App\\Controller\\BackendController'] = $instance = new \App\Controller\BackendController(($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\Backend\\CollaboratorUserService'] ?? $this->getCollaboratorUserServiceService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()));
    ...
    protected function getCollaboratorControllerService()
    {
        ...
        $this->services['App\\Controller\\CollaboratorController'] = $instance = new \App\Controller\CollaboratorController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\CollaboratorController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\CollaboratorUserController' shared autowired service.
     *
     * @return \App\Controller\CollaboratorUserController
     */
    protected function getCollaboratorUserControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/CollaboratorUserController.php';

        $this->services['App\\Controller\\CollaboratorUserController'] = $instance = new \App\Controller\CollaboratorUserController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\CollaboratorUserController', $this));
     ...
     */
    protected function getFrontendControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/FrontendController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/BranchOfficeService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/CraneService.php';

        $a = ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService());
        $b = ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService());
        $c = ($this->services['translator'] ?? $this->getTranslatorService());
        $d = ($this->privates['App\\Service\\Backend\\SecurityService'] ?? $this->getSecurityServiceService());
        $e = ($this->privates['App\\Service\\Backend\\AttachmentService'] ?? $this->getAttachmentServiceService());
        $f = ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService());

        $this->services['App\\Controller\\FrontendController'] = $instance = new \App\Controller\FrontendController(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), $a, $b, new \App\Service\Backend\BranchOfficeService($a, $c, $b, $d), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), $e, new \App\Service\Backend\CraneService($a, $c, $b, $d, $f, ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), $e), ($this->privates['App\\Service\\Backend\\OperatorService'] ?? $this->getOperatorServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), $f, ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()));

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\FrontendController', $this));
    ...
    protected function getTestControllerService()
    {
        ...
        return $this->services['App\\Controller\\TestController'] = new \App\Controller\TestController(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()));
    }

    /**
     * Gets the public 'App\Controller\UtilsController' shared autowired service.
     *
     * @return \App\Controller\UtilsController
     */
    protected function getUtilsControllerService()
    {
        include_once \dirname(__DIR__, 4).'/src/Controller/UtilsController.php';

        return $this->services['App\\Controller\\UtilsController'] = new \App\Controller\UtilsController(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FgNRgIb3yt', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QiqkyjIO2z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getConsole_CommandLoaderService()
    {
        ...
        return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Command\\TestARCommand' => ['privates', 'App\\Command\\TestARCommand', 'getTestARCommandService', false],
            'App\\Command\\TestDebugCommand' => ['privates', 'App\\Command\\TestDebugCommand', 'getTestDebugCommandService', false],
            'App\\Command\\TestDebugCopyCommand' => ['privates', 'App\\Command\\TestDebugCopyCommand', 'getTestDebugCopyCommandService', false],
            'App\\Command\\TestJVCommand' => ['privates', 'App\\Command\\TestJVCommand', 'getTestJVCommandService', false],
            'App\\Command\\TestJVSyncCommand' => ['privates', 'App\\Command\\TestJVSyncCommand', 'getTestJVSyncCommandService', false],
            'App\\Command\\cronAutoNoAvailabilityOperatorCommand' => ['privates', 'App\\Command\\cronAutoNoAvailabilityOperatorCommand', 'getCronAutoNoAvailabilityOperatorCommandService', false],
            'App\\Command\\cronAutoRefuseInterventionCommand' => ['privates', 'App\\Command\\cronAutoRefuseInterventionCommand', 'getCronAutoRefuseInterventionCommandService', false],
            'App\\Command\\cronEmailToFileCommand' => ['privates', 'App\\Command\\cronEmailToFileCommand', 'getCronEmailToFileCommandService', false],
            'App\\Command\\cronSearchCranesCommand' => ['privates', 'App\\Command\\cronSearchCranesCommand', 'getCronSearchCranesCommandService', false],
            'App\\Command\\cronSyncBranchOfficeDataCommand' => ['privates', 'App\\Command\\cronSyncBranchOfficeDataCommand', 'getCronSyncBranchOfficeDataCommandService', false],
            'App\\Command\\cronSyncMasterTableCommand' => ['privates', 'App\\Command\\cronSyncMasterTableCommand', 'getCronSyncMasterTableCommandService', false],
            'App\\Command\\fixParametersCommand' => ['privates', 'App\\Command\\fixParametersCommand', 'getFixParametersCommandService', false],
            'App\\Command\\fixTranslationsCommand' => ['privates', 'App\\Command\\fixTranslationsCommand', 'getFixTranslationsCommandService', false],
            'App\\Command\\functAddMissingTranslationsCommand' => ['privates', 'App\\Command\\functAddMissingTranslationsCommand', 'getFunctAddMissingTranslationsCommandService', false],
            'App\\Command\\functCreateCollaboratorUserCommand' => ['privates', 'App\\Command\\functCreateCollaboratorUserCommand', 'getFunctCreateCollaboratorUserCommandService', false],
            'App\\Command\\functCreateUserCommand' => ['privates', 'App\\Command\\functCreateUserCommand', 'getFunctCreateUserCommandService', false],
            'App\\Command\\functTranslationsExportCommand' => ['privates', 'App\\Command\\functTranslationsExportCommand', 'getFunctTranslationsExportCommandService', false],
            'App\\Command\\functTranslationsUpdateDBCommand' => ['privates', 'App\\Command\\functTranslationsUpdateDBCommand', 'getFunctTranslationsUpdateDBCommandService', false],
            ...
            'App\\Command\\TestARCommand' => 'App\\Command\\TestARCommand',
            'App\\Command\\TestDebugCommand' => 'App\\Command\\TestDebugCommand',
            'App\\Command\\TestDebugCopyCommand' => 'App\\Command\\TestDebugCopyCommand',
            'App\\Command\\TestJVCommand' => 'App\\Command\\TestJVCommand',
            'App\\Command\\TestJVSyncCommand' => 'App\\Command\\TestJVSyncCommand',
            'App\\Command\\cronAutoNoAvailabilityOperatorCommand' => 'App\\Command\\cronAutoNoAvailabilityOperatorCommand',
            'App\\Command\\cronAutoRefuseInterventionCommand' => 'App\\Command\\cronAutoRefuseInterventionCommand',
            'App\\Command\\cronEmailToFileCommand' => 'App\\Command\\cronEmailToFileCommand',
            'App\\Command\\cronSearchCranesCommand' => 'App\\Command\\cronSearchCranesCommand',
            'App\\Command\\cronSyncBranchOfficeDataCommand' => 'App\\Command\\cronSyncBranchOfficeDataCommand',
            'App\\Command\\cronSyncMasterTableCommand' => 'App\\Command\\cronSyncMasterTableCommand',
            'App\\Command\\fixParametersCommand' => 'App\\Command\\fixParametersCommand',
            'App\\Command\\fixTranslationsCommand' => 'App\\Command\\fixTranslationsCommand',
            'App\\Command\\functAddMissingTranslationsCommand' => 'App\\Command\\functAddMissingTranslationsCommand',
            'App\\Command\\functCreateCollaboratorUserCommand' => 'App\\Command\\functCreateCollaboratorUserCommand',
            'App\\Command\\functCreateUserCommand' => 'App\\Command\\functCreateUserCommand',
            'App\\Command\\functTranslationsExportCommand' => 'App\\Command\\functTranslationsExportCommand',
            'App\\Command\\functTranslationsUpdateDBCommand' => 'App\\Command\\functTranslationsUpdateDBCommand',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\AttachmentTypeRepository' => ['privates', 'App\\Repository\\AttachmentTypeRepository', 'getAttachmentTypeRepositoryService', false],
            'App\\Repository\\AvailabilityOperatorStatusRepository' => ['privates', 'App\\Repository\\AvailabilityOperatorStatusRepository', 'getAvailabilityOperatorStatusRepositoryService', false],
            'App\\Repository\\AvailabilityStatusRepository' => ['privates', 'App\\Repository\\AvailabilityStatusRepository', 'getAvailabilityStatusRepositoryService', false],
            'App\\Repository\\BlackListRepository' => ['privates', 'App\\Repository\\BlackListRepository', 'getBlackListRepositoryService', false],
            'App\\Repository\\BranchOfficeCraneRepository' => ['privates', 'App\\Repository\\BranchOfficeCraneRepository', 'getBranchOfficeCraneRepositoryService', false],
            'App\\Repository\\BranchOfficeOperatorRepository' => ['privates', 'App\\Repository\\BranchOfficeOperatorRepository', 'getBranchOfficeOperatorRepositoryService', false],
            'App\\Repository\\BranchOfficeRepository' => ['privates', 'App\\Repository\\BranchOfficeRepository', 'getBranchOfficeRepositoryService', false],
            'App\\Repository\\BranchOfficeServiceRepository' => ['privates', 'App\\Repository\\BranchOfficeServiceRepository', 'getBranchOfficeServiceRepositoryService', false],
            ...
            'App\\Repository\\CancellationTypeRepository' => ['privates', 'App\\Repository\\CancellationTypeRepository', 'getCancellationTypeRepositoryService', false],
            ...
            'App\\Repository\\CollaboratorServiceRepository' => ['privates', 'App\\Repository\\CollaboratorServiceRepository', 'getCollaboratorServiceRepositoryService', false],
            'App\\Repository\\CollaboratorUserRepository' => ['privates', 'App\\Repository\\CollaboratorUserRepository', 'getCollaboratorUserRepositoryService', false],
            ...
            'App\\Repository\\CraneManagementTypeRepository' => ['privates', 'App\\Repository\\CraneManagementTypeRepository', 'getCraneManagementTypeRepositoryService', false],
            'App\\Repository\\CraneRepository' => ['privates', 'App\\Repository\\CraneRepository', 'getCraneRepositoryService', false],
            'App\\Repository\\CraneServiceRepository' => ['privates', 'App\\Repository\\CraneServiceRepository', 'getCraneServiceRepositoryService', false],
            'App\\Repository\\CraneServiceTypeRepository' => ['privates', 'App\\Repository\\CraneServiceTypeRepository', 'getCraneServiceTypeRepositoryService', false],
            'App\\Repository\\CraneStatusRepository' => ['privates', 'App\\Repository\\CraneStatusRepository', 'getCraneStatusRepositoryService', false],
            'App\\Repository\\CraneTypeRepository' => ['privates', 'App\\Repository\\CraneTypeRepository', 'getCraneTypeRepositoryService', false],
            'App\\Repository\\FailureCauseTypeRepository' => ['privates', 'App\\Repository\\FailureCauseTypeRepository', 'getFailureCauseTypeRepositoryService', false],
            'App\\Repository\\FailureTypeRepository' => ['privates', 'App\\Repository\\FailureTypeRepository', 'getFailureTypeRepositoryService', false],
            'App\\Repository\\GeopositionRepository' => ['privates', 'App\\Repository\\GeopositionRepository', 'getGeopositionRepositoryService', false],
            'App\\Repository\\IncidenceOfPhaseRepository' => ['privates', 'App\\Repository\\IncidenceOfPhaseRepository', 'getIncidenceOfPhaseRepositoryService', false],
            'App\\Repository\\IncidenceTypeRepository' => ['privates', 'App\\Repository\\IncidenceTypeRepository', 'getIncidenceTypeRepositoryService', false],
            'App\\Repository\\InsuranceEntityRepository' => ['privates', 'App\\Repository\\InsuranceEntityRepository', 'getInsuranceEntityRepositoryService', false],
            'App\\Repository\\InterventionFailsRepository' => ['privates', 'App\\Repository\\InterventionFailsRepository', 'getInterventionFailsRepositoryService', false],
            'App\\Repository\\InterventionFailureTypeRepository' => ['privates', 'App\\Repository\\InterventionFailureTypeRepository', 'getInterventionFailureTypeRepositoryService', false],
            'App\\Repository\\InterventionLogRepository' => ['privates', 'App\\Repository\\InterventionLogRepository', 'getInterventionLogRepositoryService', false],
            'App\\Repository\\InterventionLogTypeRepository' => ['privates', 'App\\Repository\\InterventionLogTypeRepository', 'getInterventionLogTypeRepositoryService', false],
            'App\\Repository\\InterventionProblemTypeRepository' => ['privates', 'App\\Repository\\InterventionProblemTypeRepository', 'getInterventionProblemTypeRepositoryService', false],
            'App\\Repository\\InterventionRepository' => ['privates', 'App\\Repository\\InterventionRepository', 'getInterventionRepositoryService', false],
            'App\\Repository\\InterventionStatusRepository' => ['privates', 'App\\Repository\\InterventionStatusRepository', 'getInterventionStatusRepositoryService', false],
            'App\\Repository\\LabeledTypeRepository' => ['privates', 'App\\Repository\\LabeledTypeRepository', 'getLabeledTypeRepositoryService', false],
            'App\\Repository\\LogRepository' => ['privates', 'App\\Repository\\LogRepository', 'getLogRepositoryService', false],
            'App\\Repository\\MailerLogRepository' => ['privates', 'App\\Repository\\MailerLogRepository', 'getMailerLogRepositoryService', false],
            'App\\Repository\\ModelRepository' => ['privates', 'App\\Repository\\ModelRepository', 'getModelRepositoryService', false],
            'App\\Repository\\OperatorAvailableCranesRepository' => ['privates', 'App\\Repository\\OperatorAvailableCranesRepository', 'getOperatorAvailableCranesRepositoryService', false],
            'App\\Repository\\OperatorRepository' => ['privates', 'App\\Repository\\OperatorRepository', 'getOperatorRepositoryService', false],
            'App\\Repository\\OperatorStatusRepository' => ['privates', 'App\\Repository\\OperatorStatusRepository', 'getOperatorStatusRepositoryService', false],
            'App\\Repository\\ParametersRepository' => ['privates', 'App\\Repository\\ParametersRepository', 'getParametersRepositoryService', false],
            'App\\Repository\\PhaseLogRepository' => ['privates', 'App\\Repository\\PhaseLogRepository', 'getPhaseLogRepositoryService', false],
            'App\\Repository\\PhaseRepository' => ['privates', 'App\\Repository\\PhaseRepository', 'getPhaseRepositoryService', false],
            ...
            'App\\Repository\\PublicHolidayRepository' => ['privates', 'App\\Repository\\PublicHolidayRepository', 'getPublicHolidayRepositoryService', false],
            'App\\Repository\\RISCauseOperatorRepository' => ['privates', 'App\\Repository\\RISCauseOperatorRepository', 'getRISCauseOperatorRepositoryService', false],
            'App\\Repository\\RISCauseRepository' => ['privates', 'App\\Repository\\RISCauseRepository', 'getRISCauseRepositoryService', false],
            'App\\Repository\\RequestCraneCollaboratorServiceRepository' => ['privates', 'App\\Repository\\RequestCraneCollaboratorServiceRepository', 'getRequestCraneCollaboratorServiceRepositoryService', false],
            'App\\Repository\\RequestCraneCraneTypeRepository' => ['privates', 'App\\Repository\\RequestCraneCraneTypeRepository', 'getRequestCraneCraneTypeRepositoryService', false],
            'App\\Repository\\RequestCraneRepository' => ['privates', 'App\\Repository\\RequestCraneRepository', 'getRequestCraneRepositoryService', false],
            'App\\Repository\\SinisterTypeExtensionRepository' => ['privates', 'App\\Repository\\SinisterTypeExtensionRepository', 'getSinisterTypeExtensionRepositoryService', false],
            'App\\Repository\\SinisterTypeRepository' => ['privates', 'App\\Repository\\SinisterTypeRepository', 'getSinisterTypeRepositoryService', false],
            'App\\Repository\\SmsLogRepository' => ['privates', 'App\\Repository\\SmsLogRepository', 'getSmsLogRepositoryService', false],
            'App\\Repository\\TownRepository' => ['privates', 'App\\Repository\\TownRepository', 'getTownRepositoryService', false],
            'App\\Repository\\TranslationsRepository' => ['privates', 'App\\Repository\\TranslationsRepository', 'getTranslationsRepositoryService', false],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', false],
            'App\\Repository\\VhBrandRepository' => ['privates', 'App\\Repository\\VhBrandRepository', 'getVhBrandRepositoryService', false],
            'App\\Repository\\VhModelRepository' => ['privates', 'App\\Repository\\VhModelRepository', 'getVhModelRepositoryService', false],
            'App\\Repository\\VhPartRepository' => ['privates', 'App\\Repository\\VhPartRepository', 'getVhPartRepositoryService', false],
            'App\\Repository\\VhSectionPartRepository' => ['privates', 'App\\Repository\\VhSectionPartRepository', 'getVhSectionPartRepositoryService', false],
            'App\\Repository\\VhSectionRepository' => ['privates', 'App\\Repository\\VhSectionRepository', 'getVhSectionRepositoryService', false],
            'App\\Repository\\VhTypeRepository' => ['privates', 'App\\Repository\\VhTypeRepository', 'getVhTypeRepositoryService', false],
            'App\\Repository\\WebhookEventRepository' => ['privates', 'App\\Repository\\WebhookEventRepository', 'getWebhookEventRepositoryService', false],
            'App\\Repository\\WebhookLogRepository' => ['privates', 'App\\Repository\\WebhookLogRepository', 'getWebhookLogRepositoryService', false],
            'App\\Repository\\WebhookRepository' => ['privates', 'App\\Repository\\WebhookRepository', 'getWebhookRepositoryService', false],
            'App\\Repository\\WebhookTypeRepository' => ['privates', 'App\\Repository\\WebhookTypeRepository', 'getWebhookTypeRepositoryService', false],
            'App\\Repository\\WheelLockRepository' => ['privates', 'App\\Repository\\WheelLockRepository', 'getWheelLockRepositoryService', false],
            'App\\Repository\\WorkingHoursRepository' => ['privates', 'App\\Repository\\WorkingHoursRepository', 'getWorkingHoursRepositoryService', false],
        ], [
            'App\\Repository\\ActivityRepository' => '?',
            'App\\Repository\\AttachmentRepository' => '?',
            'App\\Repository\\AttachmentTypeRepository' => '?',
            'App\\Repository\\AvailabilityOperatorStatusRepository' => '?',
            'App\\Repository\\AvailabilityStatusRepository' => '?',
            'App\\Repository\\BlackListRepository' => '?',
            'App\\Repository\\BranchOfficeCraneRepository' => '?',
            'App\\Repository\\BranchOfficeOperatorRepository' => '?',
            'App\\Repository\\BranchOfficeRepository' => '?',
            'App\\Repository\\BranchOfficeServiceRepository' => '?',
            'App\\Repository\\BrandRepository' => '?',
            'App\\Repository\\BudgetRepository' => '?',
            'App\\Repository\\CancellationTypeRepository' => '?',
            'App\\Repository\\CollaboratorRepository' => '?',
            'App\\Repository\\CollaboratorServiceRepository' => '?',
            'App\\Repository\\CollaboratorUserRepository' => '?',
            'App\\Repository\\ContactRepository' => '?',
            'App\\Repository\\CountryRepository' => '?',
            'App\\Repository\\CraneManagementTypeRepository' => '?',
            'App\\Repository\\CraneRepository' => '?',
            'App\\Repository\\CraneServiceRepository' => '?',
            'App\\Repository\\CraneServiceTypeRepository' => '?',
            'App\\Repository\\CraneStatusRepository' => '?',
            'App\\Repository\\CraneTypeRepository' => '?',
            'App\\Repository\\FailureCauseTypeRepository' => '?',
            'App\\Repository\\FailureTypeRepository' => '?',
            'App\\Repository\\GeopositionRepository' => '?',
            'App\\Repository\\IncidenceOfPhaseRepository' => '?',
            'App\\Repository\\IncidenceTypeRepository' => '?',
            'App\\Repository\\InsuranceEntityRepository' => '?',
            'App\\Repository\\InterventionFailsRepository' => '?',
            'App\\Repository\\InterventionFailureTypeRepository' => '?',
            'App\\Repository\\InterventionLogRepository' => '?',
            'App\\Repository\\InterventionLogTypeRepository' => '?',
            'App\\Repository\\InterventionProblemTypeRepository' => '?',
            'App\\Repository\\InterventionRepository' => '?',
            'App\\Repository\\InterventionStatusRepository' => '?',
            'App\\Repository\\LabeledTypeRepository' => '?',
            'App\\Repository\\LogRepository' => '?',
            'App\\Repository\\MailerLogRepository' => '?',
            'App\\Repository\\ModelRepository' => '?',
            'App\\Repository\\OperatorAvailableCranesRepository' => '?',
            'App\\Repository\\OperatorRepository' => '?',
            'App\\Repository\\OperatorStatusRepository' => '?',
            'App\\Repository\\ParametersRepository' => '?',
            'App\\Repository\\PhaseLogRepository' => '?',
            'App\\Repository\\PhaseRepository' => '?',
            'App\\Repository\\PhoneRepository' => '?',
            'App\\Repository\\ProvinceRepository' => '?',
            'App\\Repository\\PublicHolidayRepository' => '?',
            'App\\Repository\\RISCauseOperatorRepository' => '?',
            'App\\Repository\\RISCauseRepository' => '?',
            'App\\Repository\\RequestCraneCollaboratorServiceRepository' => '?',
            'App\\Repository\\RequestCraneCraneTypeRepository' => '?',
            'App\\Repository\\RequestCraneRepository' => '?',
            'App\\Repository\\SinisterTypeExtensionRepository' => '?',
            'App\\Repository\\SinisterTypeRepository' => '?',
            'App\\Repository\\SmsLogRepository' => '?',
            'App\\Repository\\TownRepository' => '?',
            'App\\Repository\\TranslationsRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\VhBrandRepository' => '?',
            'App\\Repository\\VhModelRepository' => '?',
            'App\\Repository\\VhPartRepository' => '?',
            'App\\Repository\\VhSectionPartRepository' => '?',
            'App\\Repository\\VhSectionRepository' => '?',
            'App\\Repository\\VhTypeRepository' => '?',
            'App\\Repository\\WebhookEventRepository' => '?',
            'App\\Repository\\WebhookLogRepository' => '?',
            'App\\Repository\\WebhookRepository' => '?',
            'App\\Repository\\WebhookTypeRepository' => '?',
            'App\\Repository\\WheelLockRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.183bT40' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_183bT40Service()
    {
        return $this->privates['.service_locator.183bT40'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'utilsService' => ['privates', 'App\\Service\\UtilsBase\\UtilsService', 'getUtilsServiceService', false],
        ], [
            'utilsService' => 'App\\Service\\UtilsBase\\UtilsService',
        ]);
    }

    /**
     * Gets the private '.service_locator.Bx8GFus' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Bx8GFusService()
    {
        return $this->privates['.service_locator.Bx8GFus'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'backendService' => ['privates', 'App\\Service\\Backend\\BackendService', 'getBackendServiceService', false],
        ], [
            'backendService' => 'App\\Service\\Backend\\BackendService',
        ]);
    }

    /**
     * Gets the private '.service_locator.H674qsr' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_H674qsrService()
    {
        return $this->privates['.service_locator.H674qsr'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'securityService' => ['privates', 'App\\Service\\Backend\\SecurityService', 'getSecurityServiceService', false],
        ], [
            'securityService' => 'App\\Service\\Backend\\SecurityService',
        ]);
    }

    /**
     * Gets the private '.service_locator.NzzUeng' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NzzUengService()
    {
        return $this->privates['.service_locator.NzzUeng'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\BackendController::debugPanelAction' => ['privates', '.service_locator.183bT40', 'get_ServiceLocator_183bT40Service', false],
            'App\\Controller\\BackendController::debugSaveAndRunAction' => ['privates', '.service_locator.q_Wr7A9', 'get_ServiceLocator_QWr7A9Service', false],
            'App\\Controller\\BackendController::editParameterAction' => ['privates', '.service_locator.Bx8GFus', 'get_ServiceLocator_Bx8GFusService', false],
            'App\\Controller\\BackendController::editTranslationAction' => ['privates', '.service_locator.Bx8GFus', 'get_ServiceLocator_Bx8GFusService', false],
            'App\\Controller\\BackendController::mailText2AjaxAction' => ['privates', '.service_locator.hNdvRz3', 'get_ServiceLocator_HNdvRz3Service', false],
            'App\\Controller\\CollaboratorUserController::changePasswordAction' => ['privates', '.service_locator.y1rcvwG', 'get_ServiceLocator_Y1rcvwGService', false],
            'App\\Controller\\FrontendController::exportBranchOfficesAction' => ['privates', '.service_locator.ryTO1OD', 'get_ServiceLocator_RyTO1ODService', false],
            'App\\Controller\\FrontendController::exportDetailBranchOfficeAction' => ['privates', '.service_locator.ryTO1OD', 'get_ServiceLocator_RyTO1ODService', false],
            'App\\Controller\\FrontendController::exportDetailCraneAction' => ['privates', '.service_locator.ryTO1OD', 'get_ServiceLocator_RyTO1ODService', false],
            'App\\Controller\\FrontendController::exportDetailOperatorAction' => ['privates', '.service_locator.ryTO1OD', 'get_ServiceLocator_RyTO1ODService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.S5jlgQs', 'get_ServiceLocator_S5jlgQsService', false],
            'App\\Controller\\SecurityController::loginBackend' => ['privates', '.service_locator.S5jlgQs', 'get_ServiceLocator_S5jlgQsService', false],
            'App\\Controller\\SecurityController::recoverPasswordAction' => ['privates', '.service_locator.H674qsr', 'get_ServiceLocator_H674qsrService', false],
            'App\\Controller\\SecurityController::sendMailForgotPasswordAction' => ['privates', '.service_locator.H674qsr', 'get_ServiceLocator_H674qsrService', false],
            'App\\Controller\\SecurityController::testAPIBackend' => ['privates', '.service_locator.183bT40', 'get_ServiceLocator_183bT40Service', false],
            'App\\Controller\\BackendController:debugPanelAction' => ['privates', '.service_locator.183bT40', 'get_ServiceLocator_183bT40Service', false],
            'App\\Controller\\BackendController:debugSaveAndRunAction' => ['privates', '.service_locator.q_Wr7A9', 'get_ServiceLocator_QWr7A9Service', false],
            'App\\Controller\\BackendController:editParameterAction' => ['privates', '.service_locator.Bx8GFus', 'get_ServiceLocator_Bx8GFusService', false],
            'App\\Controller\\BackendController:editTranslationAction' => ['privates', '.service_locator.Bx8GFus', 'get_ServiceLocator_Bx8GFusService', false],
            ...
            'App\\Controller\\BackendController::debugPanelAction' => '?',
            'App\\Controller\\BackendController::debugSaveAndRunAction' => '?',
            'App\\Controller\\BackendController::editParameterAction' => '?',
            'App\\Controller\\BackendController::editTranslationAction' => '?',
            'App\\Controller\\BackendController::mailText2AjaxAction' => '?',
            'App\\Controller\\CollaboratorUserController::changePasswordAction' => '?',
            'App\\Controller\\FrontendController::exportBranchOfficesAction' => '?',
            'App\\Controller\\FrontendController::exportDetailBranchOfficeAction' => '?',
            'App\\Controller\\FrontendController::exportDetailCraneAction' => '?',
            'App\\Controller\\FrontendController::exportDetailOperatorAction' => '?',
            'App\\Controller\\SecurityController::login' => '?',
            'App\\Controller\\SecurityController::loginBackend' => '?',
            'App\\Controller\\SecurityController::recoverPasswordAction' => '?',
            'App\\Controller\\SecurityController::sendMailForgotPasswordAction' => '?',
            'App\\Controller\\SecurityController::testAPIBackend' => '?',
            'App\\Controller\\BackendController:debugPanelAction' => '?',
            'App\\Controller\\BackendController:debugSaveAndRunAction' => '?',
            'App\\Controller\\BackendController:editParameterAction' => '?',
            'App\\Controller\\BackendController:editTranslationAction' => '?',
    ...
    /**
     * Gets the private '.service_locator.S5jlgQs' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_S5jlgQsService()
    {
        return $this->privates['.service_locator.S5jlgQs'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.hNdvRz3' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_HNdvRz3Service()
    {
        return $this->privates['.service_locator.hNdvRz3'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'mailerService' => ['privates', 'App\\Service\\Utils\\MailerService', 'getMailerServiceService', false],
        ], [
            'mailerService' => 'App\\Service\\Utils\\MailerService',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.ryTO1OD' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RyTO1ODService()
    {
        return $this->privates['.service_locator.ryTO1OD'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'excelService' => ['privates', 'App\\Service\\Utils\\ExcelService', 'getExcelServiceService', false],
        ], [
            'excelService' => 'App\\Service\\Utils\\ExcelService',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.y1rcvwG' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Y1rcvwGService()
    {
        return $this->privates['.service_locator.y1rcvwG'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'collaboratorUserService' => ['privates', 'App\\Service\\Backend\\CollaboratorUserService', 'getCollaboratorUserServiceService', false],
        ], [
            'collaboratorUserService' => 'App\\Service\\Backend\\CollaboratorUserService',
        ]);
    }

    /**
     * Gets the private 'App\Command\TestARCommand' shared autowired service.
     *
     * @return \App\Command\TestARCommand
     */
    protected function getTestARCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/TestARCommand.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/DataTableService.php';

        $this->privates['App\\Command\\TestARCommand'] = $instance = new \App\Command\TestARCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())), ($this->privates['App\\Service\\EventsAndSync\\WebhookService'] ?? $this->getWebhookServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Backend\\DataTableService'] ?? ($this->privates['App\\Service\\Backend\\DataTableService'] = new \App\Service\Backend\DataTableService())), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()));

        $instance->setName('testAR');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\TestDebugCommand' shared autowired service.
     *
     * @return \App\Command\TestDebugCommand
     */
    protected function getTestDebugCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/TestDebugCommand.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/DataTableService.php';

        $this->privates['App\\Command\\TestDebugCommand'] = $instance = new \App\Command\TestDebugCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())), ($this->privates['App\\Service\\EventsAndSync\\WebhookService'] ?? $this->getWebhookServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Backend\\DataTableService'] ?? ($this->privates['App\\Service\\Backend\\DataTableService'] = new \App\Service\Backend\DataTableService())), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()));

        $instance->setName('testDebug');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\TestDebugCopyCommand' shared autowired service.
     *
     * @return \App\Command\TestDebugCopyCommand
     */
    protected function getTestDebugCopyCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/TestDebugCopyCommand.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/DataTableService.php';

        $this->privates['App\\Command\\TestDebugCopyCommand'] = $instance = new \App\Command\TestDebugCopyCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())), ($this->privates['App\\Service\\EventsAndSync\\WebhookService'] ?? $this->getWebhookServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Backend\\DataTableService'] ?? ($this->privates['App\\Service\\Backend\\DataTableService'] = new \App\Service\Backend\DataTableService())), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()));

        $instance->setName('testDebugCopy');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\TestJVCommand' shared autowired service.
     *
     * @return \App\Command\TestJVCommand
     */
    protected function getTestJVCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/TestJVCommand.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/DataTableService.php';

        $this->privates['App\\Command\\TestJVCommand'] = $instance = new \App\Command\TestJVCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())), ($this->privates['App\\Service\\EventsAndSync\\WebhookService'] ?? $this->getWebhookServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Backend\\DataTableService'] ?? ($this->privates['App\\Service\\Backend\\DataTableService'] = new \App\Service\Backend\DataTableService())), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()));

        $instance->setName('testJV');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\TestJVSyncCommand' shared autowired service.
     *
     * @return \App\Command\TestJVSyncCommand
     */
    protected function getTestJVSyncCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/TestJVSyncCommand.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/DataTableService.php';

        $this->privates['App\\Command\\TestJVSyncCommand'] = $instance = new \App\Command\TestJVSyncCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\ExcelService'] ?? $this->getExcelServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\PdfService'] ?? $this->getPdfServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())), ($this->privates['App\\Service\\EventsAndSync\\WebhookService'] ?? $this->getWebhookServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Backend\\DataTableService'] ?? ($this->privates['App\\Service\\Backend\\DataTableService'] = new \App\Service\Backend\DataTableService())), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()), ($this->privates['App\\Service\\Backend\\UsersService'] ?? $this->getUsersServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\API\\ApiService'] ?? $this->getApiServiceService()));

        $instance->setName('testJVSync');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronAutoNoAvailabilityOperatorCommand' shared autowired service.
     *
     * @return \App\Command\cronAutoNoAvailabilityOperatorCommand
     */
    protected function getCronAutoNoAvailabilityOperatorCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronAutoNoAvailabilityOperatorCommand.php';

        $this->privates['App\\Command\\cronAutoNoAvailabilityOperatorCommand'] = $instance = new \App\Command\cronAutoNoAvailabilityOperatorCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\Backend\\OperatorService'] ?? $this->getOperatorServiceService()));

        $instance->setName('cronAutoNoAvailabilityOperator');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronAutoRefuseInterventionCommand' shared autowired service.
     *
     * @return \App\Command\cronAutoRefuseInterventionCommand
     */
    protected function getCronAutoRefuseInterventionCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronAutoRefuseInterventionCommand.php';

        $this->privates['App\\Command\\cronAutoRefuseInterventionCommand'] = $instance = new \App\Command\cronAutoRefuseInterventionCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()));

        $instance->setName('cronAutoRefuseIntervention');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronEmailToFileCommand' shared autowired service.
     *
     * @return \App\Command\cronEmailToFileCommand
     */
    protected function getCronEmailToFileCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronEmailToFileCommand.php';

        $this->privates['App\\Command\\cronEmailToFileCommand'] = $instance = new \App\Command\cronEmailToFileCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this);

        $instance->setName('cronEmailToFile');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronSearchCranesCommand' shared autowired service.
     *
     * @return \App\Command\cronSearchCranesCommand
     */
    protected function getCronSearchCranesCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronSearchCranesCommand.php';

        $this->privates['App\\Command\\cronSearchCranesCommand'] = $instance = new \App\Command\cronSearchCranesCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()));

        $instance->setName('cronSearchCranes');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronSyncBranchOfficeDataCommand' shared autowired service.
     *
     * @return \App\Command\cronSyncBranchOfficeDataCommand
     */
    protected function getCronSyncBranchOfficeDataCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronSyncBranchOfficeDataCommand.php';

        $this->privates['App\\Command\\cronSyncBranchOfficeDataCommand'] = $instance = new \App\Command\cronSyncBranchOfficeDataCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()));

        $instance->setName('cronSyncBranchOfficeData');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\cronSyncMasterTableCommand' shared autowired service.
     *
     * @return \App\Command\cronSyncMasterTableCommand
     */
    protected function getCronSyncMasterTableCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/cronSyncMasterTableCommand.php';

        $this->privates['App\\Command\\cronSyncMasterTableCommand'] = $instance = new \App\Command\cronSyncMasterTableCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()));

        $instance->setName('cronSyncMasterTable');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\fixParametersCommand' shared autowired service.
     *
     * @return \App\Command\fixParametersCommand
     */
    protected function getFixParametersCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/fixParametersCommand.php';

        $this->privates['App\\Command\\fixParametersCommand'] = $instance = new \App\Command\fixParametersCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));

        $instance->setName('fixParameters');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\fixTranslationsCommand' shared autowired service.
     *
     * @return \App\Command\fixTranslationsCommand
     */
    protected function getFixTranslationsCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/fixTranslationsCommand.php';

        $this->privates['App\\Command\\fixTranslationsCommand'] = $instance = new \App\Command\fixTranslationsCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\Utils\\TranslationService'] ?? $this->getTranslationServiceService()));

        $instance->setName('fixTranslations');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\functAddMissingTranslationsCommand' shared autowired service.
     *
     * @return \App\Command\functAddMissingTranslationsCommand
     */
    protected function getFunctAddMissingTranslationsCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/functAddMissingTranslationsCommand.php';

        $this->privates['App\\Command\\functAddMissingTranslationsCommand'] = $instance = new \App\Command\functAddMissingTranslationsCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()));

        $instance->setName('functAddMissingTranslations');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\functCreateCollaboratorUserCommand' shared autowired service.
     *
     * @return \App\Command\functCreateCollaboratorUserCommand
     */
    protected function getFunctCreateCollaboratorUserCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/functCreateCollaboratorUserCommand.php';

        $this->privates['App\\Command\\functCreateCollaboratorUserCommand'] = $instance = new \App\Command\functCreateCollaboratorUserCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()));

        $instance->setName('functCreateCollaboratorUser');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\functCreateUserCommand' shared autowired service.
     *
     * @return \App\Command\functCreateUserCommand
     */
    protected function getFunctCreateUserCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/functCreateUserCommand.php';

        $this->privates['App\\Command\\functCreateUserCommand'] = $instance = new \App\Command\functCreateUserCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()));

        $instance->setName('functCreateUser');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\functTranslationsExportCommand' shared autowired service.
     *
     * @return \App\Command\functTranslationsExportCommand
     */
    protected function getFunctTranslationsExportCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/functTranslationsExportCommand.php';

        $this->privates['App\\Command\\functTranslationsExportCommand'] = $instance = new \App\Command\functTranslationsExportCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()));

        $instance->setName('functTranslationsExport');

        return $instance;
    }

    /**
     * Gets the private 'App\Command\functTranslationsUpdateDBCommand' shared autowired service.
     *
     * @return \App\Command\functTranslationsUpdateDBCommand
     */
    protected function getFunctTranslationsUpdateDBCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/functTranslationsUpdateDBCommand.php';

        $this->privates['App\\Command\\functTranslationsUpdateDBCommand'] = $instance = new \App\Command\functTranslationsUpdateDBCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()));

        $instance->setName('functTranslationsUpdateDB');
    ...
    protected function getAttachmentRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\AttachmentRepository'] = new \App\Repository\AttachmentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\AttachmentTypeRepository' shared autowired service.
     *
     * @return \App\Repository\AttachmentTypeRepository
     */
    protected function getAttachmentTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/AttachmentTypeRepository.php';

        return $this->privates['App\\Repository\\AttachmentTypeRepository'] = new \App\Repository\AttachmentTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\AvailabilityOperatorStatusRepository' shared autowired service.
     *
     * @return \App\Repository\AvailabilityOperatorStatusRepository
     */
    protected function getAvailabilityOperatorStatusRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/AvailabilityOperatorStatusRepository.php';

        return $this->privates['App\\Repository\\AvailabilityOperatorStatusRepository'] = new \App\Repository\AvailabilityOperatorStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\AvailabilityStatusRepository' shared autowired service.
     *
     * @return \App\Repository\AvailabilityStatusRepository
     */
    protected function getAvailabilityStatusRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/AvailabilityStatusRepository.php';

        return $this->privates['App\\Repository\\AvailabilityStatusRepository'] = new \App\Repository\AvailabilityStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\BlackListRepository' shared autowired service.
     *
     * @return \App\Repository\BlackListRepository
     */
    protected function getBlackListRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/BlackListRepository.php';

        return $this->privates['App\\Repository\\BlackListRepository'] = new \App\Repository\BlackListRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\BranchOfficeCraneRepository' shared autowired service.
     *
     * @return \App\Repository\BranchOfficeCraneRepository
     */
    protected function getBranchOfficeCraneRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/BranchOfficeCraneRepository.php';

        return $this->privates['App\\Repository\\BranchOfficeCraneRepository'] = new \App\Repository\BranchOfficeCraneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\BranchOfficeOperatorRepository' shared autowired service.
     *
     * @return \App\Repository\BranchOfficeOperatorRepository
     */
    protected function getBranchOfficeOperatorRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/BranchOfficeOperatorRepository.php';

        return $this->privates['App\\Repository\\BranchOfficeOperatorRepository'] = new \App\Repository\BranchOfficeOperatorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\BranchOfficeRepository' shared autowired service.
     *
     * @return \App\Repository\BranchOfficeRepository
     */
    protected function getBranchOfficeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/BranchOfficeRepository.php';

        return $this->privates['App\\Repository\\BranchOfficeRepository'] = new \App\Repository\BranchOfficeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\BranchOfficeServiceRepository' shared autowired service.
     *
     * @return \App\Repository\BranchOfficeServiceRepository
     */
    protected function getBranchOfficeServiceRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/BranchOfficeServiceRepository.php';

        return $this->privates['App\\Repository\\BranchOfficeServiceRepository'] = new \App\Repository\BranchOfficeServiceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\CancellationTypeRepository' shared autowired service.
     *
     * @return \App\Repository\CancellationTypeRepository
     */
    protected function getCancellationTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CancellationTypeRepository.php';

        return $this->privates['App\\Repository\\CancellationTypeRepository'] = new \App\Repository\CancellationTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\CollaboratorServiceRepository' shared autowired service.
     *
     * @return \App\Repository\CollaboratorServiceRepository
     */
    protected function getCollaboratorServiceRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CollaboratorServiceRepository.php';

        return $this->privates['App\\Repository\\CollaboratorServiceRepository'] = new \App\Repository\CollaboratorServiceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\CollaboratorUserRepository' shared autowired service.
     *
     * @return \App\Repository\CollaboratorUserRepository
     */
    protected function getCollaboratorUserRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/CollaboratorUserRepository.php';

        return $this->privates['App\\Repository\\CollaboratorUserRepository'] = new \App\Repository\CollaboratorUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\CraneManagementTypeRepository' shared autowired service.
     *
     * @return \App\Repository\CraneManagementTypeRepository
     */
    protected function getCraneManagementTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneManagementTypeRepository.php';

        return $this->privates['App\\Repository\\CraneManagementTypeRepository'] = new \App\Repository\CraneManagementTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\CraneRepository' shared autowired service.
     *
     * @return \App\Repository\CraneRepository
     */
    protected function getCraneRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneRepository.php';

        return $this->privates['App\\Repository\\CraneRepository'] = new \App\Repository\CraneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\CraneServiceRepository' shared autowired service.
     *
     * @return \App\Repository\CraneServiceRepository
     */
    protected function getCraneServiceRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneServiceRepository.php';

        return $this->privates['App\\Repository\\CraneServiceRepository'] = new \App\Repository\CraneServiceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\CraneServiceTypeRepository' shared autowired service.
     *
     * @return \App\Repository\CraneServiceTypeRepository
     */
    protected function getCraneServiceTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneServiceTypeRepository.php';

        return $this->privates['App\\Repository\\CraneServiceTypeRepository'] = new \App\Repository\CraneServiceTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\CraneStatusRepository' shared autowired service.
     *
     * @return \App\Repository\CraneStatusRepository
     */
    protected function getCraneStatusRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneStatusRepository.php';

        return $this->privates['App\\Repository\\CraneStatusRepository'] = new \App\Repository\CraneStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\CraneTypeRepository' shared autowired service.
     *
     * @return \App\Repository\CraneTypeRepository
     */
    protected function getCraneTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/CraneTypeRepository.php';

        return $this->privates['App\\Repository\\CraneTypeRepository'] = new \App\Repository\CraneTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\FailureCauseTypeRepository' shared autowired service.
     *
     * @return \App\Repository\FailureCauseTypeRepository
     */
    protected function getFailureCauseTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/FailureCauseTypeRepository.php';

        return $this->privates['App\\Repository\\FailureCauseTypeRepository'] = new \App\Repository\FailureCauseTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\FailureTypeRepository' shared autowired service.
     *
     * @return \App\Repository\FailureTypeRepository
     */
    protected function getFailureTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/FailureTypeRepository.php';

        return $this->privates['App\\Repository\\FailureTypeRepository'] = new \App\Repository\FailureTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\GeopositionRepository' shared autowired service.
     *
     * @return \App\Repository\GeopositionRepository
     */
    protected function getGeopositionRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/GeopositionRepository.php';

        return $this->privates['App\\Repository\\GeopositionRepository'] = new \App\Repository\GeopositionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\IncidenceOfPhaseRepository' shared autowired service.
     *
     * @return \App\Repository\IncidenceOfPhaseRepository
     */
    protected function getIncidenceOfPhaseRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/IncidenceOfPhaseRepository.php';

        return $this->privates['App\\Repository\\IncidenceOfPhaseRepository'] = new \App\Repository\IncidenceOfPhaseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\IncidenceTypeRepository' shared autowired service.
     *
     * @return \App\Repository\IncidenceTypeRepository
     */
    protected function getIncidenceTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/IncidenceTypeRepository.php';

        return $this->privates['App\\Repository\\IncidenceTypeRepository'] = new \App\Repository\IncidenceTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\InsuranceEntityRepository' shared autowired service.
     *
     * @return \App\Repository\InsuranceEntityRepository
     */
    protected function getInsuranceEntityRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InsuranceEntityRepository.php';

        return $this->privates['App\\Repository\\InsuranceEntityRepository'] = new \App\Repository\InsuranceEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionFailsRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionFailsRepository
     */
    protected function getInterventionFailsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionFailsRepository.php';

        return $this->privates['App\\Repository\\InterventionFailsRepository'] = new \App\Repository\InterventionFailsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionFailureTypeRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionFailureTypeRepository
     */
    protected function getInterventionFailureTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionFailureTypeRepository.php';

        return $this->privates['App\\Repository\\InterventionFailureTypeRepository'] = new \App\Repository\InterventionFailureTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionLogRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionLogRepository
     */
    protected function getInterventionLogRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionLogRepository.php';

        return $this->privates['App\\Repository\\InterventionLogRepository'] = new \App\Repository\InterventionLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionLogTypeRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionLogTypeRepository
     */
    protected function getInterventionLogTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionLogTypeRepository.php';

        return $this->privates['App\\Repository\\InterventionLogTypeRepository'] = new \App\Repository\InterventionLogTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionProblemTypeRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionProblemTypeRepository
     */
    protected function getInterventionProblemTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionProblemTypeRepository.php';

        return $this->privates['App\\Repository\\InterventionProblemTypeRepository'] = new \App\Repository\InterventionProblemTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getInterventionRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        return $this->privates['App\\Repository\\InterventionRepository'] = new \App\Repository\InterventionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()));
    }

    /**
     * Gets the private 'App\Repository\InterventionStatusRepository' shared autowired service.
     *
     * @return \App\Repository\InterventionStatusRepository
     */
    protected function getInterventionStatusRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/InterventionStatusRepository.php';

        return $this->privates['App\\Repository\\InterventionStatusRepository'] = new \App\Repository\InterventionStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\LabeledTypeRepository' shared autowired service.
     *
     * @return \App\Repository\LabeledTypeRepository
     */
    protected function getLabeledTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/LabeledTypeRepository.php';

        return $this->privates['App\\Repository\\LabeledTypeRepository'] = new \App\Repository\LabeledTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\MailerLogRepository' shared autowired service.
     *
     * @return \App\Repository\MailerLogRepository
     */
    protected function getMailerLogRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/MailerLogRepository.php';

        return $this->privates['App\\Repository\\MailerLogRepository'] = new \App\Repository\MailerLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\OperatorAvailableCranesRepository' shared autowired service.
     *
     * @return \App\Repository\OperatorAvailableCranesRepository
     */
    protected function getOperatorAvailableCranesRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OperatorAvailableCranesRepository.php';

        return $this->privates['App\\Repository\\OperatorAvailableCranesRepository'] = new \App\Repository\OperatorAvailableCranesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\OperatorRepository' shared autowired service.
     *
     * @return \App\Repository\OperatorRepository
     */
    protected function getOperatorRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/User/PasswordUpgraderInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OperatorRepository.php';

        return $this->privates['App\\Repository\\OperatorRepository'] = new \App\Repository\OperatorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\OperatorStatusRepository' shared autowired service.
     *
     * @return \App\Repository\OperatorStatusRepository
     */
    protected function getOperatorStatusRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OperatorStatusRepository.php';

        return $this->privates['App\\Repository\\OperatorStatusRepository'] = new \App\Repository\OperatorStatusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ParametersRepository' shared autowired service.
     *
     * @return \App\Repository\ParametersRepository
     */
    protected function getParametersRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ParametersRepository.php';

        return $this->privates['App\\Repository\\ParametersRepository'] = new \App\Repository\ParametersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\PhaseLogRepository' shared autowired service.
     *
     * @return \App\Repository\PhaseLogRepository
     */
    protected function getPhaseLogRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/PhaseLogRepository.php';

        return $this->privates['App\\Repository\\PhaseLogRepository'] = new \App\Repository\PhaseLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
     ...
     */
    protected function getPhaseRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/PhaseRepository.php';
    ...
    protected function getProvinceRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ProvinceRepository.php';
    ...
    /**
     * Gets the private 'App\Repository\PublicHolidayRepository' shared autowired service.
     *
     * @return \App\Repository\PublicHolidayRepository
     */
    protected function getPublicHolidayRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/PublicHolidayRepository.php';

        return $this->privates['App\\Repository\\PublicHolidayRepository'] = new \App\Repository\PublicHolidayRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\RISCauseOperatorRepository' shared autowired service.
     *
     * @return \App\Repository\RISCauseOperatorRepository
     */
    protected function getRISCauseOperatorRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RISCauseOperatorRepository.php';

        return $this->privates['App\\Repository\\RISCauseOperatorRepository'] = new \App\Repository\RISCauseOperatorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\RISCauseRepository' shared autowired service.
     *
     * @return \App\Repository\RISCauseRepository
     */
    protected function getRISCauseRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RISCauseRepository.php';

        return $this->privates['App\\Repository\\RISCauseRepository'] = new \App\Repository\RISCauseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\RequestCraneCollaboratorServiceRepository' shared autowired service.
     *
     * @return \App\Repository\RequestCraneCollaboratorServiceRepository
     */
    protected function getRequestCraneCollaboratorServiceRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RequestCraneCollaboratorServiceRepository.php';

        return $this->privates['App\\Repository\\RequestCraneCollaboratorServiceRepository'] = new \App\Repository\RequestCraneCollaboratorServiceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\RequestCraneCraneTypeRepository' shared autowired service.
     *
     * @return \App\Repository\RequestCraneCraneTypeRepository
     */
    protected function getRequestCraneCraneTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RequestCraneCraneTypeRepository.php';

        return $this->privates['App\\Repository\\RequestCraneCraneTypeRepository'] = new \App\Repository\RequestCraneCraneTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\RequestCraneRepository' shared autowired service.
     *
     * @return \App\Repository\RequestCraneRepository
     */
    protected function getRequestCraneRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/RequestCraneRepository.php';

        return $this->privates['App\\Repository\\RequestCraneRepository'] = new \App\Repository\RequestCraneRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\SinisterTypeExtensionRepository' shared autowired service.
     *
     * @return \App\Repository\SinisterTypeExtensionRepository
     */
    protected function getSinisterTypeExtensionRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/SinisterTypeExtensionRepository.php';

        return $this->privates['App\\Repository\\SinisterTypeExtensionRepository'] = new \App\Repository\SinisterTypeExtensionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\SinisterTypeRepository' shared autowired service.
     *
     * @return \App\Repository\SinisterTypeRepository
     */
    protected function getSinisterTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/SinisterTypeRepository.php';

        return $this->privates['App\\Repository\\SinisterTypeRepository'] = new \App\Repository\SinisterTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\SmsLogRepository' shared autowired service.
     *
     * @return \App\Repository\SmsLogRepository
     */
    protected function getSmsLogRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/SmsLogRepository.php';

        return $this->privates['App\\Repository\\SmsLogRepository'] = new \App\Repository\SmsLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\TranslationsRepository' shared autowired service.
     *
     * @return \App\Repository\TranslationsRepository
     */
    protected function getTranslationsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/TranslationsRepository.php';

        return $this->privates['App\\Repository\\TranslationsRepository'] = new \App\Repository\TranslationsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\VhBrandRepository' shared autowired service.
     *
     * @return \App\Repository\VhBrandRepository
     */
    protected function getVhBrandRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhBrandRepository.php';

        return $this->privates['App\\Repository\\VhBrandRepository'] = new \App\Repository\VhBrandRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\VhModelRepository' shared autowired service.
     *
     * @return \App\Repository\VhModelRepository
     */
    protected function getVhModelRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhModelRepository.php';

        return $this->privates['App\\Repository\\VhModelRepository'] = new \App\Repository\VhModelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\VhPartRepository' shared autowired service.
     *
     * @return \App\Repository\VhPartRepository
     */
    protected function getVhPartRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhPartRepository.php';

        return $this->privates['App\\Repository\\VhPartRepository'] = new \App\Repository\VhPartRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\VhSectionPartRepository' shared autowired service.
     *
     * @return \App\Repository\VhSectionPartRepository
     */
    protected function getVhSectionPartRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhSectionPartRepository.php';

        return $this->privates['App\\Repository\\VhSectionPartRepository'] = new \App\Repository\VhSectionPartRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\VhSectionRepository' shared autowired service.
     *
     * @return \App\Repository\VhSectionRepository
     */
    protected function getVhSectionRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhSectionRepository.php';

        return $this->privates['App\\Repository\\VhSectionRepository'] = new \App\Repository\VhSectionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Repository\VhTypeRepository' shared autowired service.
     *
     * @return \App\Repository\VhTypeRepository
     */
    protected function getVhTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/VhTypeRepository.php';

        return $this->privates['App\\Repository\\VhTypeRepository'] = new \App\Repository\VhTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\WebhookEventRepository' shared autowired service.
     *
     * @return \App\Repository\WebhookEventRepository
     */
    protected function getWebhookEventRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/WebhookEventRepository.php';

        return $this->privates['App\\Repository\\WebhookEventRepository'] = new \App\Repository\WebhookEventRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\WebhookLogRepository' shared autowired service.
     *
     * @return \App\Repository\WebhookLogRepository
     */
    protected function getWebhookLogRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/WebhookLogRepository.php';

        return $this->privates['App\\Repository\\WebhookLogRepository'] = new \App\Repository\WebhookLogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\WebhookTypeRepository' shared autowired service.
     *
     * @return \App\Repository\WebhookTypeRepository
     */
    protected function getWebhookTypeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/WebhookTypeRepository.php';

        return $this->privates['App\\Repository\\WebhookTypeRepository'] = new \App\Repository\WebhookTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\WheelLockRepository' shared autowired service.
     *
     * @return \App\Repository\WheelLockRepository
     */
    protected function getWheelLockRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/WheelLockRepository.php';

        return $this->privates['App\\Repository\\WheelLockRepository'] = new \App\Repository\WheelLockRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\WorkingHoursRepository' shared autowired service.
     *
     * @return \App\Repository\WorkingHoursRepository
     */
    protected function getWorkingHoursRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/WorkingHoursRepository.php';

        return $this->privates['App\\Repository\\WorkingHoursRepository'] = new \App\Repository\WorkingHoursRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Security\CollaboratorUserAuthenticator' shared autowired service.
     *
     * @return \App\Security\CollaboratorUserAuthenticator
     */
    protected function getCollaboratorUserAuthenticatorService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/EntryPoint/AuthenticationEntryPointInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/AuthenticatorInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/AbstractGuardAuthenticator.php';
        ...
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/PasswordAuthenticatedInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Util/TargetPathTrait.php';
        include_once \dirname(__DIR__, 4).'/src/Security/CollaboratorUserAuthenticator.php';

        return $this->privates['App\\Security\\CollaboratorUserAuthenticator'] = new \App\Security\CollaboratorUserAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()));
    }

    /**
     * Gets the private 'App\Security\OperatorAuthenticator' shared autowired service.
     *
     * @return \App\Security\OperatorAuthenticator
     */
    protected function getOperatorAuthenticatorService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/EntryPoint/AuthenticationEntryPointInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/AuthenticatorInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/AbstractGuardAuthenticator.php';
        include_once \dirname(__DIR__, 4).'/src/Security/OperatorAuthenticator.php';

        return $this->privates['App\\Security\\OperatorAuthenticator'] = new \App\Security\OperatorAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }

    /**
     * Gets the private 'App\Service\API\ApiService' shared autowired service.
     *
     * @return \App\Service\API\ApiService
     */
    protected function getApiServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/API/ApiService.php';

        return $this->privates['App\\Service\\API\\ApiService'] = new \App\Service\API\ApiService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->privates['App\\Service\\Backend\\SecurityService'] ?? $this->getSecurityServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\AttachmentService' shared autowired service.
     *
     * @return \App\Service\Backend\AttachmentService
     */
    protected function getAttachmentServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/AttachmentService.php';

        return $this->privates['App\\Service\\Backend\\AttachmentService'] = new \App\Service\Backend\AttachmentService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\BackendService' shared autowired service.
     *
     * @return \App\Service\Backend\BackendService
     */
    protected function getBackendServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/BackendService.php';

        return $this->privates['App\\Service\\Backend\\BackendService'] = new \App\Service\Backend\BackendService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\SecurityService'] ?? $this->getSecurityServiceService()), ($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->services['session'] ?? $this->getSessionService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\CollaboratorUserService' shared autowired service.
     *
     * @return \App\Service\Backend\CollaboratorUserService
     */
    protected function getCollaboratorUserServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/CollaboratorUserService.php';

        return $this->privates['App\\Service\\Backend\\CollaboratorUserService'] = new \App\Service\Backend\CollaboratorUserService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\SecurityService'] ?? $this->getSecurityServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\InterventionService' shared autowired service.
     *
     * @return \App\Service\Backend\InterventionService
     */
    protected function getInterventionServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/InterventionService.php';

        return $this->privates['App\\Service\\Backend\\InterventionService'] = new \App\Service\Backend\InterventionService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $this, ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\Utils\\MapsService'] ?? $this->getMapsServiceService()), ($this->privates['App\\Service\\Utils\\FirebaseService'] ?? $this->getFirebaseServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Backend\\BackendService'] ?? $this->getBackendServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\OperatorService' shared autowired service.
     *
     * @return \App\Service\Backend\OperatorService
     */
    protected function getOperatorServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/OperatorService.php';

        return $this->privates['App\\Service\\Backend\\OperatorService'] = new \App\Service\Backend\OperatorService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\SecurityService'] ?? $this->getSecurityServiceService()), ($this->privates['App\\Service\\EventsAndSync\\SyncService'] ?? $this->getSyncServiceService()), ($this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] ?? $this->getUpdateRequestServiceService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Backend\\AttachmentService'] ?? $this->getAttachmentServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\SecurityService' shared autowired service.
     *
     * @return \App\Service\Backend\SecurityService
     */
    protected function getSecurityServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/SecurityService.php';

        return $this->privates['App\\Service\\Backend\\SecurityService'] = new \App\Service\Backend\SecurityService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Utils\\MailerService'] ?? $this->getMailerServiceService()));
    }

    /**
     * Gets the private 'App\Service\Backend\UsersService' shared autowired service.
     *
     * @return \App\Service\Backend\UsersService
     */
    protected function getUsersServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/UsersService.php';

        return $this->privates['App\\Service\\Backend\\UsersService'] = new \App\Service\Backend\UsersService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\ValidatorService'] ?? $this->getValidatorServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }

    /**
     * Gets the private 'App\Service\Backend\ValidatorService' shared autowired service.
     *
     * @return \App\Service\Backend\ValidatorService
     */
    protected function getValidatorServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Backend/ValidatorService.php';

        return $this->privates['App\\Service\\Backend\\ValidatorService'] = new \App\Service\Backend\ValidatorService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\EventsAndSync\SyncService' shared autowired service.
     *
     * @return \App\Service\EventsAndSync\SyncService
     */
    protected function getSyncServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/SyncService.php';

        return $this->privates['App\\Service\\EventsAndSync\\SyncService'] = new \App\Service\EventsAndSync\SyncService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\EventsAndSync\WebhookService' shared autowired service.
     *
     * @return \App\Service\EventsAndSync\WebhookService
     */
    protected function getWebhookServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsAndSync/WebhookCustomService.php';

        return $this->privates['App\\Service\\EventsAndSync\\WebhookService'] = new \App\Service\EventsAndSync\WebhookService(($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] ?? ($this->privates['App\\Service\\EventsAndSync\\WebhookCustomService'] = new \App\Service\EventsAndSync\WebhookCustomService())));
    }

    /**
     * Gets the private 'App\Service\UpdateRequest\UpdateRequestService' shared autowired service.
     *
     * @return \App\Service\UpdateRequest\UpdateRequestService
     */
    protected function getUpdateRequestServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/UpdateRequest/UpdateRequestService.php';

        return $this->privates['App\\Service\\UpdateRequest\\UpdateRequestService'] = new \App\Service\UpdateRequest\UpdateRequestService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()), ($this->privates['App\\Service\\Backend\\InterventionService'] ?? $this->getInterventionServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Service\\Utils\\LogService'] ?? $this->getLogServiceService()), ($this->privates['App\\Service\\Utils\\SmsService'] ?? $this->getSmsServiceService()));
    }

    /**
     * Gets the private 'App\Service\UtilsBase\UtilsService' shared autowired service.
     *
     * @return \App\Service\UtilsBase\UtilsService
     */
    protected function getUtilsServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/UtilsBase/UtilsService.php';

        return $this->privates['App\\Service\\UtilsBase\\UtilsService'] = new \App\Service\UtilsBase\UtilsService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()));
    }

    /**
     * Gets the private 'App\Service\Utils\ExcelService' shared autowired service.
     *
     * @return \App\Service\Utils\ExcelService
     */
    protected function getExcelServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/ExcelService.php';

        return $this->privates['App\\Service\\Utils\\ExcelService'] = new \App\Service\Utils\ExcelService(($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\FirebaseService' shared autowired service.
     *
     * @return \App\Service\Utils\FirebaseService
     */
    protected function getFirebaseServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/FirebaseService.php';

        return $this->privates['App\\Service\\Utils\\FirebaseService'] = new \App\Service\Utils\FirebaseService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\LogService' shared autowired service.
     *
     * @return \App\Service\Utils\LogService
     */
    protected function getLogServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/LogService.php';

        return $this->privates['App\\Service\\Utils\\LogService'] = new \App\Service\Utils\LogService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\MailerService' shared autowired service.
     *
     * @return \App\Service\Utils\MailerService
     */
    protected function getMailerServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/MailerService.php';

        return $this->privates['App\\Service\\Utils\\MailerService'] = new \App\Service\Utils\MailerService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\MapsService' shared autowired service.
     *
     * @return \App\Service\Utils\MapsService
     */
    protected function getMapsServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/MapsService.php';

        return $this->privates['App\\Service\\Utils\\MapsService'] = new \App\Service\Utils\MapsService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\PdfService' shared autowired service.
     *
     * @return \App\Service\Utils\PdfService
     */
    protected function getPdfServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/PdfService.php';

        return $this->privates['App\\Service\\Utils\\PdfService'] = new \App\Service\Utils\PdfService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['kernel'] ?? $this->get('kernel', 1)), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->services['twig'] ?? $this->getTwigService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\SmsService' shared autowired service.
     *
     * @return \App\Service\Utils\SmsService
     */
    protected function getSmsServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/SmsService.php';

        return $this->privates['App\\Service\\Utils\\SmsService'] = new \App\Service\Utils\SmsService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }

    /**
     * Gets the private 'App\Service\Utils\TranslationService' shared autowired service.
     *
     * @return \App\Service\Utils\TranslationService
     */
    protected function getTranslationServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Utils/TranslationService.php';

        return $this->privates['App\\Service\\Utils\\TranslationService'] = new \App\Service\Utils\TranslationService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['App\\Service\\UtilsBase\\UtilsService'] ?? $this->getUtilsServiceService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AXIpE5bH9N', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vXAX8awmVu', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Erj+X-UUmv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hZNsEu0vll', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BWg30HGVcq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getConsole_Command_TranslationDebugService()
    {
        ...
        $this->privates['console.command.translation_debug'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationDebugCommand(($this->services['translator'] ?? $this->getTranslatorService()), ($this->privates['translation.reader'] ?? $this->getTranslation_ReaderService()), ($this->privates['translation.extractor'] ?? $this->getTranslation_ExtractorService()), (\dirname(__DIR__, 4).'/translations'), (\dirname(__DIR__, 4).'/templates'), [0 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Resources/translations'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Resources/translations'), 2 => (\dirname(__DIR__, 4).'/vendor/symfony/security-core/Resources/translations')], [0 => (\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Email'), 1 => (\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Form'), 2 => (\dirname(__DIR__, 4).'/src/Command/TestARCommand.php'), 3 => (\dirname(__DIR__, 4).'/src/Command/TestDebugCommand.php'), 4 => (\dirname(__DIR__, 4).'/src/Command/TestDebugCopyCommand.php'), 5 => (\dirname(__DIR__, 4).'/src/Command/TestJVCommand.php'), 6 => (\dirname(__DIR__, 4).'/src/Command/TestJVSyncCommand.php'), 7 => (\dirname(__DIR__, 4).'/src/Command/fixTranslationsCommand.php'), 8 => (\dirname(__DIR__, 4).'/src/Command/functAddMissingTranslationsCommand.php'), 9 => (\dirname(__DIR__, 4).'/src/Command/functTranslationsExportCommand.php'), 10 => (\dirname(__DIR__, 4).'/src/Command/functTranslationsUpdateDBCommand.php'), 11 => (\dirname(__DIR__, 4).'/src/Controller/BackendController.php'), 12 => (\dirname(__DIR__, 4).'/src/Service/Backend/BranchOfficeService.php'), 13 => (\dirname(__DIR__, 4).'/src/Service/Backend/CraneService.php'), 14 => (\dirname(__DIR__, 4).'/src/Service/Backend/AttachmentService.php'), 15 => (\dirname(__DIR__, 4).'/src/Service/Backend/BackendService.php'), 16 => (\dirname(__DIR__, 4).'/src/Service/Backend/CollaboratorUserService.php'), 17 => (\dirname(__DIR__, 4).'/src/Service/Backend/InterventionService.php'), 18 => (\dirname(__DIR__, 4).'/src/Service/Backend/OperatorService.php'), 19 => (\dirname(__DIR__, 4).'/src/Service/Backend/SecurityService.php'), 20 => (\dirname(__DIR__, 4).'/src/Service/Backend/ValidatorService.php'), 21 => (\dirname(__DIR__, 4).'/src/Service/EventsAndSync/SyncService.php'), 22 => (\dirname(__DIR__, 4).'/src/Service/UpdateRequest/UpdateRequestService.php'), 23 => (\dirname(__DIR__, 4).'/src/Service/Utils/FirebaseService.php'), 24 => (\dirname(__DIR__, 4).'/src/Service/Utils/MailerService.php'), 25 => (\dirname(__DIR__, 4).'/src/Service/Utils/PdfService.php'), 26 => (\dirname(__DIR__, 4).'/src/Service/Utils/SmsService.php'), 27 => (\dirname(__DIR__, 4).'/src/Service/Utils/TranslationService.php'), 28 => (\dirname(__DIR__, 4).'/src/Service/UtilsBase/UtilsService.php'), 29 => (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Command/TranslationDebugCommand.php'), 30 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Extension/Core/Type/FileType.php'), 31 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Extension/Core/Type/TransformationFailureExtension.php'), 32 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Extension/Validator/Type/UploadValidatorExtension.php'), 33 => (\dirname(__DIR__, 4).'/vendor/symfony/form/Extension/Csrf/Type/FormTypeCsrfExtension.php'), 34 => (\dirname(__DIR__, 4).'/vendor/symfony/validator/Util/LegacyTranslatorProxy.php'), 35 => (\dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/CacheWarmer/TranslationsCacheWarmer.php'), 36 => (\dirname(__DIR__, 4).'/vendor/symfony/translation/DataCollector/TranslationDataCollector.php'), 37 => (\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Extension/TranslationExtension.php')]);
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.NzzUeng'] ?? $this->get_ServiceLocator_NzzUengService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(es|en|ru|it|pt|fr)/'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend/(login|login_check|logout)'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/(login|login_check|logout)'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend'), [0 => 'ROLE_BACKEND'], NULL);
    ...
    /**
     * Gets the private 'security.authentication.listener.anonymous.frontend' shared service.
     *
     * @return \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener
     */
    ...
    protected function getSecurity_Authentication_Listener_Guard_ApiService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.api'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'api', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\OperatorAuthenticator'] ?? $this->getOperatorAuthenticatorService());
    ...
    protected function getSecurity_Authentication_Listener_Guard_BackendService()
    {
        ...
        $this->privates['security.authentication.listener.guard.backend'] = $instance = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'backend', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\BackendAuthenticator'] ?? $this->getBackendAuthenticatorService());
        }, 1), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));

        $instance->setRememberMeServices(($this->privates['security.authentication.rememberme.services.simplehash.backend'] ?? $this->getSecurity_Authentication_Rememberme_Services_Simplehash_BackendService()));

        return $instance;
    }

    /**
     * Gets the private 'security.authentication.listener.guard.frontend' shared service.
     *
     * @return \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener
     */
    protected function getSecurity_Authentication_Listener_Guard_FrontendService()
    {
        ...
        $this->privates['security.authentication.listener.guard.frontend'] = $instance = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'frontend', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\CollaboratorUserAuthenticator'] ?? $this->getCollaboratorUserAuthenticatorService());
        }, 1), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));

        $instance->setRememberMeServices(($this->privates['security.authentication.rememberme.services.simplehash.frontend'] ?? $this->getSecurity_Authentication_Rememberme_Services_Simplehash_FrontendService()));

        return $instance;
    }

    /**
     * Gets the private 'security.authentication.listener.rememberme.backend' shared service.
     *
     * @return \Symfony\Component\Security\Http\Firewall\RememberMeListener
     */
    protected function getSecurity_Authentication_Listener_Rememberme_BackendService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/AbstractListener.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/ListenerInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/LegacyListenerTrait.php';
    ...
    protected function getSecurity_Authentication_Listener_Rememberme_FrontendService()
    {
        ...
        return $this->privates['security.authentication.listener.rememberme.frontend'] = new \Symfony\Component\Security\Http\Firewall\RememberMeListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), ($this->privates['security.authentication.rememberme.services.simplehash.frontend'] ?? $this->getSecurity_Authentication_Rememberme_Services_Simplehash_FrontendService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), true, ($this->privates['security.authentication.session_strategy'] ?? ($this->privates['security.authentication.session_strategy'] = new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'))));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.backend'] ?? $this->getSecurity_Authentication_Provider_Guard_BackendService());
            yield 1 => ($this->privates['security.authentication.provider.rememberme.backend'] ?? $this->getSecurity_Authentication_Provider_Rememberme_BackendService());
            yield 2 => ($this->privates['security.authentication.provider.anonymous.backend'] ?? ($this->privates['security.authentication.provider.anonymous.backend'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            yield 3 => ($this->privates['security.authentication.provider.guard.frontend'] ?? $this->getSecurity_Authentication_Provider_Guard_FrontendService());
            yield 4 => ($this->privates['security.authentication.provider.rememberme.frontend'] ?? $this->getSecurity_Authentication_Provider_Rememberme_FrontendService());
            ...
            yield 6 => ($this->privates['security.authentication.provider.guard.api'] ?? $this->getSecurity_Authentication_Provider_Guard_ApiService());
            yield 7 => ($this->privates['security.authentication.provider.anonymous.api'] ?? ($this->privates['security.authentication.provider.anonymous.api'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
        }, 8), true);
    ...
    protected function getSecurity_Authentication_Provider_Guard_ApiService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.api'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\OperatorAuthenticator'] ?? $this->getOperatorAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.api_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_ApiUserProviderService()), 'api', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_Authentication_Provider_Guard_BackendService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.backend'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\BackendAuthenticator'] ?? $this->getBackendAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.backend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_BackendUserProviderService()), 'backend', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }

    /**
     * Gets the private 'security.authentication.provider.guard.frontend' shared service.
     *
     * @return \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Guard_FrontendService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.frontend'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\CollaboratorUserAuthenticator'] ?? $this->getCollaboratorUserAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.frontend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_FrontendUserProviderService()), 'frontend', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }

    /**
     * Gets the private 'security.authentication.provider.rememberme.backend' shared service.
     *
     * @return \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Rememberme_BackendService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/Authentication/Provider/AuthenticationProviderInterface.php';
        ...
        return $this->privates['security.authentication.provider.rememberme.backend'] = new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider(($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), $this->getEnv('APP_SECRET'), 'backend');
    }

    /**
     * Gets the private 'security.authentication.provider.rememberme.frontend' shared service.
     *
     * @return \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Rememberme_FrontendService()
    {
        ...
        return $this->privates['security.authentication.provider.rememberme.frontend'] = new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider(($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), $this->getEnv('APP_SECRET'), 'frontend');
    }

    /**
     * Gets the private 'security.authentication.rememberme.services.simplehash.backend' shared service.
     *
     * @return \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices
     */
    protected function getSecurity_Authentication_Rememberme_Services_Simplehash_BackendService()
    {
        ...
        return $this->privates['security.authentication.rememberme.services.simplehash.backend'] = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices([0 => ($this->privates['security.user.provider.concrete.backend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_BackendUserProviderService())], $this->getEnv('APP_SECRET'), 'backend', ['lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => NULL, 'httponly' => true, 'samesite' => 'lax', 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'], ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));
    }

    /**
     * Gets the private 'security.authentication.rememberme.services.simplehash.frontend' shared service.
     *
     * @return \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices
     */
    protected function getSecurity_Authentication_Rememberme_Services_Simplehash_FrontendService()
    {
        ...
        return $this->privates['security.authentication.rememberme.services.simplehash.frontend'] = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices([0 => ($this->privates['security.user.provider.concrete.frontend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_FrontendUserProviderService())], $this->getEnv('APP_SECRET'), 'frontend', ['lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => NULL, 'httponly' => true, 'samesite' => 'lax', 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'], ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));
    }
    ...
    protected function getSecurity_Command_UserPasswordEncoderService()
    {
        ...
        $this->privates['security.command.user_password_encoder'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\UserPasswordEncoderCommand(($this->privates['security.encoder_factory.generic'] ?? $this->getSecurity_EncoderFactory_GenericService()), [0 => 'App\\Entity\\CollaboratorUser', 1 => 'App\\Entity\\Operator', 2 => 'App\\Entity\\User']);
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        $this->privates['security.context_listener.0'] = $instance = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.frontend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_FrontendUserProviderService());
            yield 1 => ($this->privates['security.user.provider.concrete.api_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_ApiUserProviderService());
            yield 2 => ($this->privates['security.user.provider.concrete.backend_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_BackendUserProviderService());
    ...
    protected function getSecurity_EncoderFactory_GenericService()
    {
        ...
        return $this->privates['security.encoder_factory.generic'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(['App\\Entity\\CollaboratorUser' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => 13, 3 => '2y']], 'App\\Entity\\Operator' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => 13, 3 => '2y']], 'App\\Entity\\User' => ['class' => 'Symfony\\Component\\Security\\Core\\Encoder\\NativePasswordEncoder', 'arguments' => [0 => NULL, 1 => NULL, 2 => 13, 3 => '2y']]]);
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.frontend' => ['privates', 'security.firewall.map.context.frontend', 'getSecurity_Firewall_Map_Context_FrontendService', false],
        ], [
            ...
            yield 'security.firewall.map.context.backend' => ($this->privates['.security.request_matcher.L5Xi7sM'] ?? ($this->privates['.security.request_matcher.L5Xi7sM'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/backend')));
            yield 'security.firewall.map.context.frontend' => NULL;
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->privates['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () {
    ...
    protected function getSecurity_Firewall_Map_Context_BackendService()
    {
        ...
        $c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($b, 'backend_login'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'backend_logout']);
        ...
        $c->addHandler(($this->privates['security.authentication.rememberme.services.simplehash.backend'] ?? $this->getSecurity_Authentication_Rememberme_Services_Simplehash_BackendService()));
        ...
        return $this->privates['security.firewall.map.context.backend'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
            ...
            yield 3 => ($this->privates['security.authentication.listener.rememberme.backend'] ?? $this->getSecurity_Authentication_Listener_Rememberme_BackendService());
        ...
        }, 6), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'backend', ($this->privates['App\\Security\\BackendAuthenticator'] ?? $this->getBackendAuthenticatorService()), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('backend', 'security.user_checker', '.security.request_matcher.L5Xi7sM', true, false, 'security.user.provider.concrete.backend_user_provider', 'backend', 'App\\Security\\BackendAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'remember_me', 2 => 'anonymous'], NULL));
    }
    ...
    /**
     * Gets the private 'security.firewall.map.context.frontend' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_FrontendService()
    {
        ...
        $c->addHandler(($this->privates['security.logout.handler.csrf_token_clearing'] ?? $this->getSecurity_Logout_Handler_CsrfTokenClearingService()));
        $c->addHandler(($this->privates['security.logout.handler.session'] ?? ($this->privates['security.logout.handler.session'] = new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler())));
        $c->addHandler(($this->privates['security.authentication.rememberme.services.simplehash.frontend'] ?? $this->getSecurity_Authentication_Rememberme_Services_Simplehash_FrontendService()));

        return $this->privates['security.firewall.map.context.frontend'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.channel_listener'] ?? $this->getSecurity_ChannelListenerService());
            yield 1 => ($this->privates['security.context_listener.1'] ?? $this->getSecurity_ContextListener_1Service());
            yield 2 => ($this->privates['security.authentication.listener.guard.frontend'] ?? $this->getSecurity_Authentication_Listener_Guard_FrontendService());
            yield 3 => ($this->privates['security.authentication.listener.rememberme.frontend'] ?? $this->getSecurity_Authentication_Listener_Rememberme_FrontendService());
            yield 4 => ($this->privates['security.authentication.listener.anonymous.frontend'] ?? $this->getSecurity_Authentication_Listener_Anonymous_FrontendService());
            yield 5 => ($this->privates['security.access_listener'] ?? $this->getSecurity_AccessListenerService());
        }, 6), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'frontend', ($this->privates['App\\Security\\CollaboratorUserAuthenticator'] ?? $this->getCollaboratorUserAuthenticatorService()), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('frontend', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.frontend_user_provider', 'frontend', 'App\\Security\\CollaboratorUserAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'remember_me', 2 => 'anonymous'], NULL), ($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('frontend', 'app_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected function getSecurity_User_Provider_Concrete_ApiUserProviderService()
    {
        ...
        return $this->privates['security.user.provider.concrete.api_user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Operator', 'email', NULL);
    }

    /**
     * Gets the private 'security.user.provider.concrete.backend_user_provider' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_BackendUserProviderService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/User/UserProviderInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/User/PasswordUpgraderInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/doctrine-bridge/Security/User/EntityUserProvider.php';

        return $this->privates['security.user.provider.concrete.backend_user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\User', NULL, NULL);
    }

    /**
     * Gets the private 'security.user.provider.concrete.frontend_user_provider' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_FrontendUserProviderService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/User/UserProviderInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-core/User/PasswordUpgraderInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/doctrine-bridge/Security/User/EntityUserProvider.php';

        return $this->privates['security.user.provider.concrete.frontend_user_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\CollaboratorUser', 'email', NULL);
    }
