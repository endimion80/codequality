...
class __TwigTemplate_6d95f1fbd94c1b4cc9769e6c8ebb50e6255e422b0192c7373580a24f049f0829 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div id=\"page-content\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["provinces"]) || array_key_exists("provinces", $context) ? $context["provinces"] : (function () { throw new RuntimeError('Variable "provinces" does not exist.', 65, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["province"]) {
            // line 66
            echo "                                        <option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["province"], "id", [], "any", false, false, false, 66), "html", null, true);
            echo "\"> ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["province"], "name", [], "any", false, false, false, 66), "html", null, true);
            echo " </option>
                                    ";
        }
    ...
    <script>
        ...
        echo "\",{
                        ...
                        \$.each(json, function (idx, obj) {
                            \$(\"#town-input\").append('<option value=\"' + obj.id + '\">' + obj.name + '</option>');
                        });
...
";
    ...
    {
        return array (  703 => 398,  688 => 384,  685 => 382,  671 => 370,  639 => 341,  632 => 337,  628 => 336,  617 => 328,  611 => 325,  606 => 323,  602 => 322,  598 => 321,  594 => 320,  590 => 319,  586 => 318,  582 => 317,  570 => 308,  556 => 296,  541 => 283,  529 => 274,  514 => 262,  501 => 252,  489 => 243,  463 => 219,  425 => 182,  422 => 180,  411 => 170,  394 => 155,  381 => 144,  378 => 142,  368 => 135,  358 => 134,  337 => 122,  333 => 121,  329 => 120,  325 => 119,  321 => 118,  317 => 117,  309 => 111,  301 => 105,  297 => 104,  291 => 100,  288 => 98,  278 => 90,  274 => 89,  268 => 86,  264 => 85,  258 => 82,  254 => 81,  248 => 78,  244 => 77,  235 => 71,  230 => 68,  219 => 66,  215 => 65,  209 => 62,  201 => 57,  196 => 55,  189 => 50,  186 => 48,  178 => 44,  172 => 43,  164 => 40,  160 => 38,  144 => 26,  136 => 23,  129 => 19,  121 => 13,  111 => 12,  98 => 8,  94 => 7,  90 => 6,  80 => 5,  61 => 3,  38 => 1,);
    }
        ...
        function createTable() {
            \$('#table_branch_offices').DataTable({
                ...
                columns: [
                    ...
                    {data: 'contactPerson'},
                    {data: {}, render: function(data, row) {
                            html = '<form action=\"{{ path(\"detail_branch_office\") }}\" method=\"POST\" style=\"margin: 0; display: flex; justify-content: center; align-items: center;\">';
                            html += '<input type=\"hidden\" name=\"branchOfficeId\" value=\"' + data[\"id\"] + '\">';
                            html += '<button class=\"btn detail-button\" style=\"color: #a4b0c0; padding: 0; box-shadow: none;\"><i class=\"fa fa-2x fa-chevron-right\"></i></button>';
                            html += '</form>'
