...
use App\Repository\VhPartRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=VhPartRepository::class)
 */
class VhPart
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=VhSectionPart::class, mappedBy="vhPart")
     */
    ...
    public function removeVhSectionPart(VhSectionPart $vhSectionPart): self
    {
        if ($this->vhSectionParts->contains($vhSectionPart)) {
            ...
            if ($vhSectionPart->getVhPart() === $this) {
                $vhSectionPart->setVhPart(null);
            }
        }
