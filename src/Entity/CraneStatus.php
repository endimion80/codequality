...
use App\Repository\CraneStatusRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=CraneStatusRepository::class)
 */
class CraneStatus
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Crane::class, mappedBy="craneStatus")
     */
    private $cranes;
    ...
    public function removeCrane(Crane $crane): self
    {
        if ($this->cranes->contains($crane)) {
            ...
            if ($crane->getCraneStatus() === $this) {
                $crane->setCraneStatus(null);
            }
        }
