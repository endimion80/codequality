...
use App\Repository\InterventionFailureTypeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=InterventionFailureTypeRepository::class)
 */
class InterventionFailureType
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity=InterventionFails::class, mappedBy="interventionFailureType")
     */
    ...
    public function addInterventionFail(InterventionFails $interventionFail): self
    {
        if (!$this->interventionFails->contains($interventionFail)) {
            ...
            $interventionFail->setInterventionFailureType($this);
        }
    ...
    public function removeInterventionFail(InterventionFails $interventionFail): self
    {
        if ($this->interventionFails->contains($interventionFail)) {
            ...
            if ($interventionFail->getInterventionFailureType() === $this) {
                $interventionFail->setInterventionFailureType(null);
            }
        }
