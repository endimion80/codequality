...
use App\Repository\OperatorStatusRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=OperatorStatusRepository::class)
 */
class OperatorStatus
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Operator::class, mappedBy="operatorStatus")
     */
    private $operators;
    ...
    public function addOperator(Operator $operator): self
    {
        if (!$this->operators->contains($operator)) {
            ...
            $operator->setOperatorStatus($this);
        }
    ...
    public function removeOperator(Operator $operator): self
    {
        if ($this->operators->contains($operator)) {
            ...
            if ($operator->getOperatorStatus() === $this) {
                $operator->setOperatorStatus(null);
            }
        }
